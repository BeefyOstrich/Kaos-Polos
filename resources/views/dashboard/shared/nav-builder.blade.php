...
?>
        ...
        <div class="c-sidebar-brand">
            <div class="d-flex">
                <img class="rounded c-sidebar-brand-full" src="{{ url('/assets/brand/nahkoda.jpeg') }}" width="40" height="40" alt="Nahkoda Logo">
                <h5 class="my-auto mx-2">Nahkoda Nusantara</h5>
            </div>
